  ...
  return (
    ...
    >
      <div className="flex items-center justify-between text-white py-5">
        <div>
          <h1 className="text-xl font-bold">Polygon Reaper Lottery</h1>
        </div>
        ...
        <div>
          <div className="text-white py-5">
            <h2 className="text-4xl font-bold py-4 ">
              Take the chance to <br /> to join the UnderWorld
            </h2>

            <p className="text-xl">
              Vibe and chat with the chance of you winning the jackpot. <br />
              just a web3 lottery born on Polygon
            </p>
          </div>
        </div>
