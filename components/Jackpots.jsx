  ...
  return (
    <div className="bg-slate-100 pt-5">
      <div className=" flex flex-col items-center justify-center">
        <h1 className="text-2xl font-bold text-slate-800 py-5">Polygon Reaper Lottery Jackpots</h1>
        <p className="text-center text-sm text-slate-600">
          Jackpot Time LFG Reapers!. <br />
          100% Fair Play.
        </p>
      </div>
