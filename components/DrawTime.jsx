  ...
  return (
    <div className="py-10 px-5 bg-slate-100">
      <div className="flex flex-col items-center justify-center text-center py-10">
        <h4 className="text-4xl text-violet-700 text-center font-bold pb-3">
          Buy Lottery Tickets Online
        </h4>
        <p className="text-lg text-purple-600 font-semibold capitalize">{jackpot?.title}</p>
        <p className="text-sm text-violet-700 w-full sm:w-2/3">{jackpot?.description}</p>
      ...
      <div className="flex flex-col justify-center items-center space-y-4 mb-6">
        ...
        <div className="flex justify-center items-center space-x-2">
          {wallet?.toLowerCase() == jackpot?.owner ? (
            <>
              <button
                ...
                onClick={onGenerate}
                className={`flex flex-nowrap border py-2 px-4 rounded-full bg-fuchsia-600
              ...
              {!group ? (
                <button
                  ...
                  className="flex flex-nowrap border py-2 px-4 rounded-full bg-fuchsia-700
            ...
            <button
              ...
              className="flex flex-nowrap border py-2 px-4 rounded-full bg-violet-900
                hover:bg-rose-600 font-semibold text-white"
            >
              Join Group
            </button>
          ...
          <Link
            ...
            className="flex flex-nowrap border py-2 px-4 rounded-full bg-[#c084fc]
          ...
          {!currentUser ? (
            <button
              ...
              className="flex flex-nowrap border py-2 px-4 rounded-full bg-purple-700
            ...
            <button
              ...
              className="flex flex-nowrap border py-2 px-4 rounded-full bg-purple-300
            hover:bg-amber-600 font-semibold"
            >
              Enter Chat
            </button>
